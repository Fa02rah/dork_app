...
class BottomNavAppointments extends GetView<AppointmentsController> {
  const BottomNavAppointments({super.key});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(Icons.event, 'المواعيد', 1, controller.goToTicket),
